...
export default function IntentQueueButton(props: Props) {
  ...
  if (props.queued > 0) {
    cls = "rounded-md border px-2 py-1 text-xs border-amber-400/50 bg-amber-500/15 text-amber-200"
  ...
  return (
    <button
      ...
      className={cls}
      title={`${props.queued} queued, ${props.applied} applied, ${props.invalid} invalid`}
    >
